...
proc create_root_design { parentCell } {
  ...
  set SLOT_0_ONOFF [ create_bd_intf_port -mode Monitor -vlnv xilinx.com:user:OnOff_rtl:1.0 SLOT_0_ONOFF ]
  ...
  connect_bd_net -net SLOT_0_ONOFF_onoff_cs_1 [get_bd_ports SLOT_0_ONOFF_onoff_cs] [get_bd_pins ila_lib/probe1]
  connect_bd_net -net SLOT_0_ONOFF_onoff_sclk_1 [get_bd_ports SLOT_0_ONOFF_onoff_sclk] [get_bd_pins ila_lib/probe3]
  connect_bd_net -net SLOT_0_ONOFF_onoff_sdi_1 [get_bd_ports SLOT_0_ONOFF_onoff_sdi] [get_bd_pins ila_lib/probe2]
  connect_bd_net -net SLOT_0_ONOFF_onoff_sdo_1 [get_bd_ports SLOT_0_ONOFF_onoff_sdo] [get_bd_pins ila_lib/probe4]
