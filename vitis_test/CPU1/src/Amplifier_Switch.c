...
//	xil_printf("CPU1:Amplifier config done = %d\r\n",  (Xil_In32(Amplifier_Switch_BASEADDR + Module_Status_ADDR) & 0x8000) >> 15);  //返回1，则配置完成
	...
	Xil_Out32(Amplifier_Switch_BASEADDR + Amplifier_Din0_ADDR, (((u32)(Wave_Amplitude[1] * DA_UB_Correct / 100)) << 16) + (u32)(Wave_Amplitude[0] * DA_UA_Correct / 100)); //din0发送，8000半幅值，ub + ua
	Xil_Out32(Amplifier_Switch_BASEADDR + Amplifier_Din1_ADDR, (((u32)(Wave_Amplitude[3] * DA_UX_Correct / 100)) << 16) + (u32)(Wave_Amplitude[2] * DA_UC_Correct / 100)); //din1发送，半幅值，ux + uc
	Xil_Out32(Amplifier_Switch_BASEADDR + Amplifier_Din2_ADDR, (((u32)(Wave_Amplitude[5] * DA_IB_Correct / 100)) << 16) + (u32)(Wave_Amplitude[4] * DA_IA1V_Correct / 100)); //din2发送，ib + ia
	Xil_Out32(Amplifier_Switch_BASEADDR + Amplifier_Din3_ADDR, (((u32)(Wave_Amplitude[7] * DA_IX_Correct / 100)) << 16) + (u32)(Wave_Amplitude[6] * DA_IC_Correct / 100)); //din3发送，ix + ic
