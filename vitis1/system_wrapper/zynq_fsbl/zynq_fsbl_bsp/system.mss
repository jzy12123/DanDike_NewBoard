...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = AC_8_channel_0_stimer_onoff_pa_rw_A_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.7
 PARAMETER HW_INSTANCE = RTC_EEPROM_axi_iic_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = power_pulse_v1_AXI_0
END
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 3.12
 PARAMETER HW_INSTANCE = axi_intc_BareMetal
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axicdma
 PARAMETER DRIVER_VER = 4.8
 PARAMETER HW_INSTANCE = AC_8_channel_0_adda_axi_cdma_0
END
